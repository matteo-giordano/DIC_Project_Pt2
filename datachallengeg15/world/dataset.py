...
class Dataset:
    ...
    def sample(self, 
               ...
               filter_criteria: Dict[str, Any] = None) -> Tuple[np.ndarray, Dict[str, Any]]:
        """
    ...
    def sample_batch(self, 
                    ...
                    height: int = None,
                    random_transform: bool = False,
                    filter_criteria: Dict[str, Any] = None) -> Tuple[np.ndarray, List[Dict[str, Any]]]:
        """
    ...
    def ensure_connectivity(self, index: int = None) -> int:
        ...
        # Process all maps
        total_removed = 0
        print("Ensuring connectivity for all maps...")
        for i, maze in enumerate(tqdm(self.maps)):
            if maze is not None:
